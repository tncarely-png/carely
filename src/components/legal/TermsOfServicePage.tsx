        ...
        <section className="py-12 md:py-16 px-4">
          <div className="max-w-3xl mx-auto">
              ...
              <div>
                ...
                <div className="bg-carely-mint rounded-xl p-4 space-y-2 text-sm">
                  <p className="flex items-center gap-2">
                    ...
                    <a href={`mailto:${CONTACT_EMAIL}`} className="text-carely-green hover:underline">{CONTACT_EMAIL}</a>
                  </p>
                  <p className="flex items-center gap-2">
                    <span className="font-bold text-carely-dark">💬</span>
                    <button onClick={() => navigate('contact')} className="text-carely-green hover:underline">صفحة تواصل معانا</button>
                  </p>
                  <p className="flex items-center gap-2">
                    <span className="font-bold text-carely-dark">🌐</span>
            ...
            <div className="mt-8 text-center">
              <button onClick={() => navigate('home')} className="carely-btn-outline inline-flex items-center gap-2">
                → الرجوع للرئيسية
              </button>
            </div>
          </div>
    ...
    <header className="sticky top-0 z-40 bg-white shadow-sm border-b-2 border-carely-green">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          <button onClick={() => navigate('home')} className="flex items-center gap-0">
          ...
          <button onClick={() => navigate('home')} className="carely-btn-outline text-sm px-4 py-2 rounded-full">
            الرئيسية
          </button>
        </div>
      </div>
...
function LegalFooter() {
  const { navigate } = useAppStore();
  return (
    <footer className="bg-carely-dark text-white pb-20 md:pb-0">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <nav className="flex items-center gap-6 text-sm">
            <button onClick={() => navigate('home')} className="text-gray-300 hover:text-white transition-colors">الرئيسية</button>
            <button onClick={() => navigate('privacy-policy')} className="text-gray-300 hover:text-white transition-colors">سياسة الخصوصية</button>
            <button onClick={() => navigate('terms-of-service')} className="text-gray-300 hover:text-white transition-colors">شروط الاستخدام</button>
          </nav>
