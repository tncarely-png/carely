...
export default function Footer() {
  ...
  return (
    <footer className="bg-carely-dark text-white pb-16 md:pb-0 safe-area-bottom">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 overflow-hidden">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Col 1: Brand */}
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-0">
              <span className="text-2xl font-extrabold text-carely-light">Carely</span>
            ...
            <div className="flex items-center gap-3 mt-2">
              ...
              <button
                ...
                aria-label="WhatsApp"
                className="cursor-pointer touch-target w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Col 2: Quick Links */}
          <div>
            <h3 className="text-base font-bold mb-4 text-carely-light">روابط سريعة</h3>
          ...
          {/* Col 3: Legal & Contact */}
          <div>
            <h3 className="text-base font-bold mb-4 text-carely-light">تواصل و دعم</h3>
            <ul className="flex flex-col gap-3">
              <li>
                <button
                  onClick={() => openWhatsAppPopup()}
